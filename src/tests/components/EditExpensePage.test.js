...
beforeEach(()=>{
    ...
    wrapper = shallow(<EditExpensePage expense={expenses[0]} editExpense={editExpenseSpy} startRemoveExpense={removeExpenseSpy} history={historySpy}/>)
})
...
test('should check the editExpense submission', () => {
